...
import { X, ChevronLeft, ChevronRight, MapPin, ShoppingCart, DollarSign, Clock, TrendingUp, Search, Filter, Users, Layers, Download, Eye, ChevronRight as ChevronRightIcon } from 'lucide-react';
...
const OrdersTour: React.FC<OrdersTourProps> = ({ isOpen, onClose, onComplete }) => {
  ...
  const tourSteps: TourStep[] = [
    {
      ...
      description: "View key metrics at a glance: Revenue Today, Today's Orders, Pending Orders, and Average Order Value",
    ...
    },
    {
      id: 'search',
      title: 'Search Orders',
      description: 'Search orders by order number, customer name, phone number, or table number',
    ...
    },
    {
      id: 'filters',
      title: 'Filter Panel',
      description: 'Use advanced filters to narrow down orders by date range, service type, order status, and payment status',
    ...
    },
    {
      ...
      description: 'Use quick date chips to filter orders: Today, Yesterday, Last 7 Days, Last 30 Days, or All Time',
      target: '[data-tour="quick-dates"]',
    ...
    },
    {
      id: 'orders-table',
      title: 'Orders Table',
      description: 'View all orders in a table with order details, status badges, and action buttons',
    ...
    },
    {
      ...
      description: 'Use action buttons to view details, print receipt, process payment, edit, or cancel orders',
    ...
    },
    {
      id: 'bulk-actions',
      title: 'Bulk Actions',
      description: 'Transfer Waiter to reassign orders to different staff, or Merge Bills to combine multiple orders',
    ...
    },
    {
      id: 'export',
      title: 'Export Orders',
      description: 'Export filtered orders to CSV file for external reporting or analysis',
  ...
  return (
    <>
      ...
      {highlightPosition && (
        <div
          className="fixed border-4 border-blue-500 rounded-lg shadow-2xl z-[100] transition-all duration-300 pointer-events-none"
          style={{
