    ...
    <div className="min-h-screen bg-gray-50/80">
      ...
      <div className="bg-white border-b border-gray-100 shadow-sm px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-xl font-extrabold text-[#2D2A26] tracking-tight">Manufacturing & Production</h1>
            <p className="text-xs text-gray-400 font-medium mt-0.5">Manage batch production, prep work, and production orders</p>
          </div>
        </div>
